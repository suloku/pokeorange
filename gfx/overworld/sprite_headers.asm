...
KrisBikeSprite: ; 14976
	sprite_header KrisBikeSpriteGFX, 3, WALKING_SPRITE, PAL_OW_RED
; 1497c
...
SightSeerSprite:
	sprite_header SightSeerSpriteGFX, 3, WALKING_SPRITE, PAL_OW_BLUE
...
RocketMeowthSprite:
	sprite_header RocketMeowthSpriteGFX, 3, WALKING_SPRITE, PAL_OW_BROWN

ChrisDiveSprite:
	sprite_header ChrisDiveSpriteGFX, 3, WALKING_SPRITE, PAL_OW_PURPLE
