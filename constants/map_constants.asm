...
; map group ids
	...
	mapgroup TROVITOPOLIS_POKE_COMM_CENTER, 14, 11
...
WILD_GRASS_MAP_MASK			EQU $00
WILD_SURF_MAP_MASK			EQU $80
WILD_UNDERWATER_MAP_MASK	EQU $C0
LANDMARK_MASK				EQU $3F
WILD_LANDMARK_MASK			EQU $C0
