	...
	const MUSIC_CIANWOOD_CITY
	const MUSIC_SLATEPORT_CITY
	const MUSIC_SOOTOPOLIS_CITY
	const MUSIC_CAVE_OF_ORIGIN
	const MUSIC_HOENN_DEWFORD_TOWN
	...
	const MUSIC_XD_BATTLE_SIM_THEME
	const MUSIC_ROUTE_119
	const MUSIC_SUNNY_SHORE
	const MUSIC_ORANGE_DIVE
	const MUSIC_RS_LOOK_LASS
	const MUSIC_ROUTE_110
	const MUSIC_ROUTE_209_N
	const MUSIC_CANALAVE
	const MUSIC_ROUTE_206
	const MUSIC_SEVII_ISLANDS
	const MUSIC_OREBURGH_GATE
	const MUSIC_FOUR_ISLAND
	const MUSIC_ROUTE_111
	const MUSIC_SIRD_BATTLE
	const MUSIC_CASTLE_ROUTE
	const MUSIC_ROUTE_24_GBS
	const MUSIC_DRIFTVEIL_CITY
	const MUSIC_TANGELO_JUNGLE
	const MUSIC_CRYSTAL_CAVE
	const MUSIC_MEET_JESSIE_JAMES
	const MUSIC_ROCKET_MOTTO
	const MUSIC_PINKAN_ISLAND
	const MUSIC_IMAKUNI_THEME
	const MUSIC_CROSS_BATTLE
	const MUSIC_TRACEY_BATTLE
	const MUSIC_MARSHADOW_BATTLE
	const MUSIC_WORLD_TOURNAMENT_FINAL
	const MUSIC_TRACEY_ENCOUNTER
	const MUSIC_ROUTE_69
	const MUSIC_LUGIAS_SONG_2000
	const MUSIC_DRAKE_BATTLE
	const MUSIC_ASCORBIA_ISLAND
	const MUSIC_ROUTE_62
	const MUSIC_ORANGE_ISLANDS_GYM_BATTLE
	const MUSIC_ORANGE_TRAINER_BATTLE
	const MUSIC_EARLY_ORANGE_ROUTE
	const MUSIC_CRIMSON_ROUTE
	const MUSIC_STARTER_ORANGE_ROUTE
	const MUSIC_CITY_ORANGE
	const MUSIC_VALENCIA_TOWN
	const MUSIC_LOOKER
	const MUSIC_ORANGE_ENCOUNTER
	const MUSIC_SOME_ORANGE_ROUTE
	const MUSIC_CROSS_ENCOUNTER
