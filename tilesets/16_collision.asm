	...
	tilecoll WALL, WALL, COUNTER, FLOOR ; 22
	...
	tilecoll COUNTER, COUNTER, FLOOR, FLOOR ; 2e
	tilecoll COUNTER, COUNTER, FLOOR, FLOOR ; 2f
	...
	tilecoll COUNTER, COUNTER, COUNTER, FLOOR ; 3b
