...
Item6Attributes:
; TOWN MAP
	item_attribute 0, 0, 0, CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; SKATEBOARD
	item_attribute 0, 0, 0, CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; MOON STONE
...
; X SPCL ATK
	item_attribute 1000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; COIN CASE
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; ITEMFINDER
	item_attribute 0, 0, 0, CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; # FLUTE
	item_attribute 0, 0, 0, CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
...
; KING'S ROCK
	item_attribute 2100, HELD_TRADE_EVOLVE, 30, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BITTER BERRY
...
; SWEET ORANGE
	item_attribute 300, 0, 20, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; GS BALL
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MIRACLE SEED
...
; METAL COAT
	item_attribute 2100, HELD_STEEL_BOOST, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DRAGON FANG
...
; SQUIRTBOTTLE
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; PARK BALL
	item_attribute 0, 0, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; BERSERK GENE
	item_attribute 200, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; MORO TROPHY
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DUBIOUS DISC
	item_attribute 9900, 0, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; SHINY CHARM
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOUL DEW
	item_attribute 100, 0, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DIVE BALL
	item_attribute 1000, 0, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; HEAL BALL
...
; ICE STONE
	item_attribute 2100, 0, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; QUICK POWDER
	item_attribute 10, HELD_QUICK_POWDER, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MAGMARIZER
	item_attribute 2100, 0, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ELECTIRIZER
	item_attribute 2100, 0, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
...
; SALVEYO WEED
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CAT STATUE
	item_attribute 65535, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHELL_BOX
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; ELECTRIC ORB
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS | CANT_PCSTORE, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; KANTO STONE
	item_attribute 2100, 0, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CHAMPION BELT
	item_attribute 65535, HELD_METAL_POWDER, 30, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHINY BALL
	item_attribute 0, 0, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; TM01
