...
; All trainers follow a basic structure:
	...
	; Example
	;	db "EXAMPLE@" ;Trainer Nickname
	
	;	db TRAINERTYPE_NICKNAME_F + TRAINERTYPE_ITEM + TRAINERTYPE_DVS + TRAINERTYPE_PERSONALITY + TRAINERTYPE_MOVES
			; Order or use of + or | here does not matter since they are bitflags, but it's good practice to keep the order
			; Use TRAINERTYPE_NORMAL as default case

	;	Order DOES matter when setting the Pokémon parameters
	;   db 88, PIKACHU, "LILCHU@", LIGHT_BALL, MALE_MASK, $98, $88, 
	;	Level, Species,  Nickname,    Item,   Personality,   DVs
	
	; 	Move list. Use NO_MOVE for empty moves, but 4 moves need to be set
	;	db THUNDERBOLT
	;	db IRON_TAIL
	;	db VOLT_TACKLE
	;	db NO_MOVE
	;
	;	Next Pokémon in the party
	;
	; 	db $FF ; this ends the trainer structure (-1 and $FF is the same, -1 could be used here too)
...
; ================
	...
	db 15, HORSEA, NO_ITEM
		db BUBBLE
		db SMOKESCREEN
		db NO_MOVE
		db NO_MOVE

	db 18, WARTORTLE, BLACKGLASSES
		db RAPID_SPIN
		db WATER_GUN
		db BUBBLEBEAM
		db WITHDRAW

	db 13, TENTACOOL, NO_ITEM
		db POISON_STING
		db SURF
		db ACID
		db WRAP
...
; ================
	...
	; CISSY (2)
	db "CISSY@"
	db TRAINERTYPE_MOVES + TRAINERTYPE_ITEM

	; party

	db 70, KINGDRA, DRAGON_FANG
		db WATER_PULSE
		db OUTRAGE
		db DRAGON_PULSE
		db SLUDGE_BOMB

	db 70, BLASTOISE, BLACKGLASSES
		db RAPID_SPIN
		db SURF
		db ICE_BEAM
		db CRUNCH

	db 70, TOXAPEX, POISON_BARB
		db VENOSHOCK
		db WATERFALL
		db DIVE
		db TOXIC

	db 70, GOLDUCK, KINGS_ROCK
		db PSYCHIC_M
		db WATERFALL
		db DISABLE
		db HYPER_BEAM

	db 70, GYARADOS, PINK_BOW
		db DRAGON_PULSE
		db THRASH
		db HYPER_BEAM
		db WATER_PULSE

	db 70, LANTURN, SCOPE_LENS
		db THUNDER
		db RAIN_DANCE
		db LOCK_ON
		db HYDRO_PUMP
...
; ================
	...
	db 75, NIDOQUEEN, NEVERMELTICE
		db BLIZZARD
		db HAIL
		db DOUBLE_KICK
		db BATON_PASS

	db 75, MACHAMP, BLACKBELT
		db DYNAMICPUNCH
		db POWERUPPUNCH
		db FISSURE
		db FOCUS_ENERGY

	db 75, SCIZOR, SILVERPOWDER
		db SIGNAL_BEAM
		db SWORDS_DANCE
		db HYPER_BEAM
		db AERIAL_ACE

	db 75, ELECTRODE, MAGNET
		db THUNDER
		db NASTY_PLOT
		db RAIN_DANCE
		db EXPLOSION

	db 75, RHYPERIOR, HARD_STONE
		db ROCK_CLIMB
		db HORN_DRILL
		db LOCK_ON
		db SURF

	db 75, NINETALES, NEVERMELTICE
		db DAZZLINGLEAM
		db BLIZZARD
		db EXTREMESPEED
		db NASTY_PLOT
...
; ================
	...
	db 80, SHARPEDO, BLACKGLASSES
		db CRUNCH
		db DIVE
		db MEAN_LOOK
		db FOCUS_ENERGY

	db 80, HITMONTOP, BLACKBELT
		db TRIPLE_KICK
		db FOCUS_ENERGY
		db SWORDS_DANCE
		db POWERUPPUNCH

	db 80, GOLEM, HARD_STONE
		db DEFENSE_CURL
		db ROLLOUT
		db FISSURE
		db LOCK_ON

	db 80, CLEFABLE, POLKADOT_BOW
		db ENCORE
		db DAZZLINGLEAM
		db DOUBLE_EDGE
		db BATON_PASS
...
; ================
	...
	db 80, MAROWAK, SOFT_SAND
		db SHADOW_BONE
		db SUNNY_DAY
		db FIRE_BLAST
		db PROTECT

	db 80, TURTONATOR, CHARCOAL
		db SHELL_TRAP
		db DRAGON_PULSE
		db FIRE_BLAST
		db NASTY_PLOT

	db 80, ALAKAZAM, TWISTEDSPOON
		db PSYCHIC_M
		db NASTY_PLOT
		db SUNNY_DAY
		db SAFEGUARD

	db 80, TROPIUS, MIRACLE_SEED
		db AERIAL_ACE
		db FLY
		db SOLARBEAM
		db SYNTHESIS

	db 80, LICKILICKY, KINGS_ROCK
		db DEFENSE_CURL
		db ROLLOUT
		db DOUBLE_EDGE
		db HYPER_BEAM

	db 80, AZUMARILL, SCOPE_LENS
		db DAZZLINGLEAM
		db WATERFALL
		db BATON_PASS
		db DOUBLE_EDGE
...
; ================
	...
	db 62, ELECTIVIRE, MAGNET
		db THUNDERPUNCH
		db BODY_SLAM
		db POWERUPPUNCH
		db AGILITY

	db 65, DRAGONITE, DRAGON_FANG
		db DRAGON_TAIL
		db DRAGON_PULSE
		db HYPER_BEAM
		db ICE_BEAM
...
; ================
	...
	db 95, MR__MIME, CHAMP_BELT
		db PSYCHIC_M
		db NASTY_PLOT
		db BARRIER
		db BATON_PASS

	db 96, STEELIX, METAL_COAT
		db DOUBLE_EDGE
		db IRON_TAIL
		db ANCIENTPOWER
		db EARTHQUAKE

	db 97, PORYGON_Z, PINK_BOW
		db CONVERSION
		db CONVERSION2
		db TRI_ATTACK
		db HYPER_BEAM

	db 98, VENUSAUR, MIRACLE_SEED
		db SUNNY_DAY
		db SOLARBEAM
		db NASTY_PLOT
		db PETAL_DANCE

	db 99, DRAGALGE, POISON_BARB
		db TOXIC
		db DRAGON_PULSE
		db VENOSHOCK
		db WATERFALL
...
; ================
	...
	db 86, BLASTOISE, "BLASTOISE@", CHAMP_BELT
		db SURF
		db ZAP_CANNON
		db ICE_BEAM
		db ROCK_CLIMB
...
; ================
	...
	db 21, SHELLDER, FEMALE_MASK
	db 21, MANKEY, MALE_MASK
...
; ================
	...
	db 40, CLOYSTER, FEMALE_MASK
		db ICE_BEAM
		db CLAMP
		db HAIL
		db SURF

	db 41, PRIMEAPE, MALE_MASK
		db DYNAMICPUNCH
		db ROCK_SMASH
		db LOCK_ON
		db DOUBLE_KICK

	db 39, SHUCKLE, MALE_MASK
		db TOXIC
		db WRAP
		db REST
		db ENCORE

	db 41, HITMONTOP, MALE_MASK
		db TRIPLE_KICK
		db RAPID_SPIN
		db DOUBLE_KICK
		db FOCUS_ENERGY
...
; ================
	...
	db 21, TENTACOOL, FEMALE_MASK
		db ACID
		db WATER_GUN
		db POISON_STING
		db NO_MOVE

	db 20, DROWZEE, MALE_MASK
		db HYPNOSIS
		db DISABLE
		db CONFUSION
		db DREAM_EATER

	db 20, RATICATE, MALE_MASK | RATICATE_ROCKET_FORM
		db BITE
		db TAIL_WHIP
		db QUICK_ATTACK
		db NO_MOVE
...
; ================
	...
	db 40, TENTACRUEL, FEMALE_MASK
		db TOXIC
		db WHIRLPOOL
		db RAIN_DANCE
		db WATERFALL

	db 41, HYPNO, MALE_MASK
		db HYPNOSIS
		db PSYCHIC_M
		db NASTY_PLOT
		db REST

	db 39, MIMIKYU, FEMALE_MASK
		db SHADOW_SNEAK
		db ASTONISH
		db SHADOW_BALL
		db ENDURE

	db 41, RATICATE, MALE_MASK | RATICATE_ROCKET_FORM
		db HYPER_FANG
		db FOCUS_ENERGY
		db REST
		db SLEEP_TALK
...
; ================
	...
	db 37, VICTREEBEL, MALE_MASK | VICTREEBEL_ROCKET_FORM
		db VINE_WHIP
		db COTTON_SPORE
		db SLUDGE_BOMB
		db BITE
...
; ================
	...
	db 38, ARBOK, FEMALE_MASK | ARBOK_ROCKET_FORM
		db CRUNCH
		db POISON_STING
		db MEAN_LOOK
		db WRAP
...
; ================================
	...
	db 32, ARBOK, FEMALE_MASK | ARBOK_ROCKET_FORM
		db POISON_STING
		db WRAP
		db CRUNCH
		db SWAGGER
	...
	db 31, VICTREEBEL, MALE_MASK | VICTREEBEL_ROCKET_FORM
		db VINE_WHIP
		db RAZOR_LEAF
		db SLEEP_POWDER
		db ACID
...
; ================
	...
	db 95, EXEGGUTOR, TWISTEDSPOON, MALE_MASK
		db OUTRAGE
		db DRAGON_PULSE
		db SUNNY_DAY
		db SOLARBEAM

	db 99, CLEFABLE, POLKADOT_BOW, FEMALE_MASK
		db DAZZLINGLEAM
		db HEAL_BELL
		db HYPER_BEAM
		db ATTRACT

	db 97, TOUCANNON, SHARP_BEAK, MALE_MASK
		db AERIAL_ACE
		db FIRE_BLAST
		db STEEL_WING
		db GLARE

	db 94, KINGDRA, DRAGON_FANG, MALE_MASK
		db HYDRO_PUMP
		db DRAGON_PULSE
		db SUBSTITUTE
		db LOCK_ON

	db 96, SALAZZLE, POISON_BARB, FEMALE_MASK | SHINY_MASK
		db FLAMETHROWER
		db TOXIC
		db VENOSHOCK
		db AGILITY

	db 98, RAICHU, MAGNET, FEMALE_MASK | SHINY_MASK
		db VOLT_TACKLE
		db DOUBLE_TEAM
		db ENCORE
		db NASTY_PLOT
...
; ================
	...
	; party
	db 15, CORSOLA, NO_ITEM
	db 15, SQUIRTLE, BLACKGLASSES
	db 16, SLOWPOKE, NO_ITEM
...
; ================
	...
	; party
	db 42, BLASTOISE, BLACKGLASSES
	db 41, WARTORTLE, BLACKGLASSES
	db 40, SQUIRTLE, BLACKGLASSES
...
; ================
	...
	db 40, HITMONTOP, "HITMONTOP@", FOCUS_BAND, $D8, $C8, MALE_MASK
		db PROTECT
		db PURSUIT
		db TRIPLE_KICK
		db COUNTER
...
; ================
	...
	db 10, DRATINI, MALE_MASK
	db 10, TRAPINCH, MALE_MASK | SHINY_MASK
	db 10, ONIX, MALE_MASK | ONIX_CRYSTAL_FORM
	db 10, TOGEPI, FEMALE_MASK | PINK_MASK
	db 10, ABRA, MALE_MASK
	...
	db 20, DRATINI, MALE_MASK
	db 20, TRAPINCH, MALE_MASK | SHINY_MASK
	db 20, ONIX, MALE_MASK | ONIX_CRYSTAL_FORM
	db 20, TOGETIC, FEMALE_MASK | PINK_MASK
	db 20, KADABRA, MALE_MASK
	...
	db 30, DRAGONAIR, MALE_MASK
	db 30, VIBRAVA, MALE_MASK | SHINY_MASK
	db 30, ONIX, MALE_MASK | ONIX_CRYSTAL_FORM
	db 30, TOGETIC, FEMALE_MASK | PINK_MASK
	db 30, KADABRA, MALE_MASK
	...
	db 45, DRAGONAIR, MALE_MASK
	db 45, VIBRAVA, MALE_MASK | SHINY_MASK
	db 45, STEELIX, MALE_MASK | STEELIX_CRYSTAL_FORM
	db 45, TOGEKISS, FEMALE_MASK | PINK_MASK
	db 45, ALAKAZAM, MALE_MASK
	...
	db 60, DRAGONITE, MALE_MASK
	db 60, FLYGON, MALE_MASK | SHINY_MASK
	db 60, STEELIX, MALE_MASK | STEELIX_CRYSTAL_FORM
	db 60, TOGEKISS, FEMALE_MASK | PINK_MASK
	db 60, ALAKAZAM, MALE_MASK
	...
	db 75, DRAGONITE, MALE_MASK
	db 75, FLYGON, MALE_MASK | SHINY_MASK
	db 75, STEELIX, MALE_MASK | STEELIX_CRYSTAL_FORM
	db 75, TOGEKISS, FEMALE_MASK | PINK_MASK
	db 75, ALAKAZAM, MALE_MASK
	...
	db 100, DRAGONITE, MALE_MASK
	db 100, FLYGON, MALE_MASK | SHINY_MASK
	db 100, STEELIX, MALE_MASK | STEELIX_CRYSTAL_FORM
	db 100, TOGEKISS, FEMALE_MASK | PINK_MASK
	db 100, ALAKAZAM, MALE_MASK
...
; ================ PUMMELO (PICK CHARMANDER)
	...
	db 59, BLASTOISE, SCOPE_LENS, MALE_MASK
		db DIVE
		db CRUNCH
		db RAPID_SPIN
		db NASTY_PLOT

	db 57, LYCANROC, HARD_STONE, MALE_MASK | LYCANROC_MIDNIGHT_FORM
		db ACCELEROCK
		db CRUNCH
		db FORESIGHT
		db EARTH_POWER

	db 56, FLAREON, CHARCOAL, MALE_MASK
		db FLAMETHROWER
		db BITE
		db QUICK_ATTACK
		db SUNNY_DAY

	db 58, SKARMORY, SHARP_BEAK, MALE_MASK
		db DRILL_PECK
		db AERIAL_ACE
		db SWORDS_DANCE
		db FLY
		
	db 59, TANGROWTH, MIRACLE_SEED, MALE_MASK
		db ANCIENTPOWER
		db LEECH_SEED
		db GIGA_DRAIN
		db SOLARBEAM
		
	db 55, MAGMORTAR, KINGS_ROCK, MALE_MASK
		db FIRE_PUNCH
		db SMOKESCREEN
		db POISON_GAS
		db FLAMETHROWER
...
; ================ PUMMELO (PICK SQUIRTLE)
	...
	db 59, VENUSAUR, MIRACLE_SEED, MALE_MASK
		db GIGA_DRAIN
		db LEECH_SEED
		db PETAL_DANCE
		db NASTY_PLOT
	...
	db 56, VAPOREON, MYSTIC_WATER, MALE_MASK
		db DIVE
		db BITE
		db SURF
		db RAIN_DANCE
	...
	db 59, RAPIDASH, PINK_BOW, MALE_MASK
		db STOMP
		db FLAME_WHEEL
		db AGILITY
		db SUNNY_DAY
		
	db 55, ELECTIVIRE, MAGNET, MALE_MASK
		db THUNDERPUNCH
		db THUNDER_WAVE
		db DYNAMICPUNCH
		db THUNDERBOLT
...
; ================ PUMMELO (PICK BULBASAUR)
	...
	db 59, CHARIZARD, CHARCOAL, MALE_MASK
		db FLAMETHROWER
		db DRAGON_TAIL
		db SLASH
		db STRENGTH
	...
	db 56, LEAFEON, MIRACLE_SEED, MALE_MASK
		db RAZOR_LEAF
		db BITE
		db AGILITY
		db GROWTH
	...
	db 59, SLOWBRO, MYSTIC_WATER, MALE_MASK
		db DIVE
		db SURF
		db REST
		db AMNESIA
		
	db 55, JYNX, NEVERMELTICE, FEMALE_MASK
		db ICE_PUNCH
		db SING
		db SWEET_KISS
		db BLIZZARD
...
; ================ ROUTE 51 (PICK CHARMANDER)
	...
	db 74, BLASTOISE, SCOPE_LENS, MALE_MASK
		db DIVE
		db CRUNCH
		db RAPID_SPIN
		db NASTY_PLOT

	db 72, LYCANROC, HARD_STONE, MALE_MASK | LYCANROC_MIDNIGHT_FORM
		db ACCELEROCK
		db CRUNCH
		db FORESIGHT
		db EARTH_POWER

	db 73, FLAREON, KINGS_ROCK, MALE_MASK
		db FLAMETHROWER
		db BITE
		db QUICK_ATTACK
		db SUNNY_DAY

	db 73, SKARMORY, SHARP_BEAK, MALE_MASK
		db DRILL_PECK
		db AERIAL_ACE
		db SWORDS_DANCE
		db FLY
		
	db 72, MAGMORTAR, CHARCOAL, MALE_MASK
		db FIRE_PUNCH
		db SMOKESCREEN
		db POISON_GAS
		db FLAMETHROWER

	db 75, MARSHADOW, SPELL_TAG, GENDERLESS_MASK
		db SHADOW_BALL
		db DIZZY_PUNCH
		db NASTY_PLOT
		db SPECTRATHIEF
...
; ================ ROUTE 51 (PICK SQUIRTLE)
	...
	db 74, VENUSAUR, MIRACLE_SEED, MALE_MASK
		db GIGA_DRAIN
		db LEECH_SEED
		db PETAL_DANCE
		db NASTY_PLOT
	...
	db 73, VAPOREON, MYSTIC_WATER, MALE_MASK
		db DIVE
		db BITE
		db SURF
		db RAIN_DANCE
	...
	db 72, ELECTIVIRE, MAGNET, MALE_MASK
		db THUNDERPUNCH
		db THUNDER_WAVE
		db DYNAMICPUNCH
		db THUNDERBOLT
...
; ================ ROUTE 51 (PICK BULBASAUR)
	...
	db 74, CHARIZARD, CHARCOAL, MALE_MASK
		db FLAMETHROWER
		db DRAGON_TAIL
		db SLASH
		db STRENGTH
	...
	db 73, LEAFEON, MIRACLE_SEED, MALE_MASK
		db RAZOR_LEAF
		db BITE
		db AGILITY
		db GROWTH
	...
	db 72, SLOWBRO, MYSTIC_WATER, MALE_MASK
		db DIVE
		db SURF
		db REST
		db AMNESIA
